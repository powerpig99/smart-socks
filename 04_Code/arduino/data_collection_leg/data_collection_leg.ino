...
<body>
  ...
  <script>
    ...
    let sensorNames = [')" + String(SENSOR_NAMES[0]) + R"(', ')" + String(SENSOR_NAMES[1]) + R"(', ')" + String(SENSOR_NAMES[2]) + R"(', ')" + String(SENSOR_NAMES[3]) + R"(', ')" + String(SENSOR_NAMES[4]) + R"(', ')" + String(SENSOR_NAMES[5]) + R"('];
